...
export class TestComponent implements OnInit {
  ...
  doTests() {
    switch (this.type) {
      ...
      case "GRUPOS":
        ...
        break;
      case "HORARIOS":
        this.doTestsHorarios();
        break;
      case "TUTORIAS":
        this.doTestsTutorias();
        break;
    }
  }

  private doTestsTutorias() {
    this.tests = [];
  ...
  gestionHorariosTest() {
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '10:00', '11:00', 'miercoles', '2022-01-12'
    ).subscribe(
      (id_horario) => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add correcto.",
          flag: true
        });
        TestComponent.initFakeCredentials();
        ...
        this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '10:00', '11:00', 'miercoles', '2022-01-12'
          ...
          () => {
            ...
            this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '17:00', '18:00', 'miercoles', '2022-01-12'
            ).subscribe(
              () => {
                this.tests.push({
                  accion: "Gestion Horarios Edit",
                  descripcion: "Edit correcto.",
                  flag: true
                });
                TestComponent.initFakeCredentials();

                this.gestionHorariosService.deleteHorario(id_horario).subscribe(
                  () => {
                    this.tests.push({
                      accion: "Gestion Horarios Delete",
                      descripcion: "Delete correcto.",
                      flag: true
                    });
                  }, () => {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.mostrartodos().subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Showall",
          descripcion: "Showall correcto.",
          flag: true
        });
      }, () => {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.show('1').subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Show",
          descripcion: "Show correcto.",
          flag: true
        });
      }, () => {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.deleteHorario('9999').subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Delete",
          descripcion: "Delete incorrecto porque no existe el horario.",
          flag: false
        });
      }, error => {
        if (error.message == '4004') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('99999', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20292030', '1', '1', '12345678Z', '1', 'Pendiente', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '99999', '1', '12345678Z', '1', 'Pendiente', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '99999', '12345678Z', '1', 'Pendiente', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no existe el grupo.",
          flag: false
        });
      }, error => {
        if (error.message == '4004') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '95702661Y', '1', 'Pendiente', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no existe el profesor.",
          flag: false
        });
      }, error => {
        if (error.message == '4004') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '999999', 'Pendiente', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no existe el espacio.",
          flag: false
        });
      }, error => {
        if (error.message == '4004') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'X', '18:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no se ha introducido correctamente la asistencia.",
          flag: false
        });
      }, error => {
        if (error.message == '404') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '1a:00', '19:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no se ha introducido correctamente la hora de inicio.",
          flag: false
        });
      }, error => {
        if (error.message == '404') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '18:00', '1a:00', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no se ha introducido correctamente la hora de fin.",
          flag: false
        });
      }, error => {
        if (error.message == '404') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '18:00', '19:00', 'miercoles', '202201-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no se ha introducido correctamente la fecha.",
          flag: false
        });
      }, error => {
        if (error.message == '404') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '18:00', '19:00', 'dia x', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque no se ha introducido correctamente el dia de la semana.",
          flag: false
        });
      }, error => {
        if (error.message == '404') {
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '12:30', '13:30', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque el espacio estará ocupado en ese momento.",
          flag: false
        });
      }, error => {
        if (error.message == '40011') {
          this.tests.push({
            accion: "Gestion Horarios Add",
            descripcion: "Add incorrecto porque el espacio estará ocupado en ese momento.",
            flag: true
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '2', 'Pendiente', '12:30', '13:30', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque el grupo estará ocupado en ese momento.",
          flag: false
        });
      }, error => {
        if (error.message == '40012') {
          this.tests.push({
            accion: "Gestion Horarios Add",
            descripcion: "Add incorrecto porque el grupo estará ocupado en ese momento.",
            flag: true
    ...
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '2', '12345678Z', '2', 'Pendiente', '12:30', '13:30', 'miercoles', '2022-01-12'
    ).subscribe(
      () => {
        this.tests.push({
          accion: "Gestion Horarios Add",
          descripcion: "Add incorrecto porque el profesor estará ocupado en ese momento.",
          flag: false
        });
      }, error => {
        if (error.message == '40013') {
          this.tests.push({
            accion: "Gestion Horarios Add",
            descripcion: "Add incorrecto porque el profesor estará ocupado en ese momento.",
            flag: true
    ...
    TestComponent.removeFakeCredentials();
    TestComponent.initFakeCredentials();
    this.gestionHorariosService.addHorario('1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '11:30', '12:00', 'miercoles', '2022-01-13'
    ).subscribe(
      (id_horario) => {

        TestComponent.initFakeCredentials();
        this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '1', 'XX', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
          () => {
            this.tests.push({
              accion: "Gestion Horarios Edit",
              descripcion: "Edit incorrecto porque no se introdujo correctamente la asistencia.",
              flag: false
            });
          }, error => {
            if (error.message == '404') {
        ...
        TestComponent.initFakeCredentials();
        this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '1a:30', '13:00', 'miercoles', '2022-01-13').subscribe(
          () => {
            this.tests.push({
              accion: "Gestion Horarios Edit",
              descripcion: "Edit incorrecto porque no se introdujo correctamente la hora de inicio.",
              flag: false
            });
          }, error => {
            if (error.message == '404') {
        ...
        TestComponent.initFakeCredentials();
        this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '12:30', '1a:00', 'miercoles', '2022-01-13').subscribe(
          () => {
            this.tests.push({
              accion: "Gestion Horarios Edit",
              descripcion: "Edit incorrecto porque no se introdujo correctamente la hora de fin.",
              flag: false
            });
          }, error => {
            if (error.message == '404') {
        ...
        TestComponent.initFakeCredentials();
        this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '12:30', '13:00', 'x', '2022-01-13').subscribe(
          () => {
            this.tests.push({
              accion: "Gestion Horarios Edit",
              descripcion: "Edit incorrecto porque no se introdujo correctamente la hora de fin.",
        ...
        TestComponent.initFakeCredentials();
        this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '12:30', '13:00', 'miercoles', '202201-13').subscribe(
          () => {
            this.tests.push({
              accion: "Gestion Horarios Edit",
              descripcion: "Edit incorrecto porque no se introdujo correctamente la hora de fin.",
        ...
        TestComponent.initFakeCredentials();
        this.gestionHorariosService.editHorario(id_horario, '9999', '20202021', '1', '1', '12345678Z', '1', 'Pendiente', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
          () => {
            this.tests.push({
              accion: "Gestion Horarios Edit",
              descripcion: "Edit incorrecto porque no existe la titulación.",
            ...
            if (error.message == '4004') {
              ...
              TestComponent.initFakeCredentials();
              this.gestionHorariosService.editHorario(id_horario, '1', '20292030', '1', '1', '12345678Z', '1', 'Pendiente', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
                () => {
                  this.tests.push({
                    accion: "Gestion Horarios Edit",
                    descripcion: "Edit incorrecto porque no existe el año academico",
                    flag: false
                  });
                }, error => {
                  if (error.message == '4004') {
                    ...
                    TestComponent.initFakeCredentials();
                    this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '99999', '1', '12345678Z', '1', 'Pendiente', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
                      () => {
                        this.tests.push({
                          accion: "Gestion Horarios Edit",
                          descripcion: "Edit incorrecto porque no existe la asignatura.",
                        ...
                        if (error.message == '4004') {
                          ...
                          TestComponent.initFakeCredentials();
                          this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '99999', '12345678Z', '1', 'Pendiente', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
                            () => {
                              this.tests.push({
                                accion: "Gestion Horarios Edit",
                                descripcion: "Edit incorrecto porque no existe el grupo.",
                                flag: false
                              });
                            }, error => {
                              if (error.message == '4004') {
                                ...
                                TestComponent.initFakeCredentials();
                                this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '95702661Y', '1', 'Pendiente', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
                                  () => {
                                    this.tests.push({
                                      accion: "Gestion Horarios Edit",
                                      descripcion: "Edit incorrecto porque no existe el profesor.",
                                      flag: false
                                    });
                                  }, error => {
                                    if (error.message == '4004') {
                                      ...
                                      TestComponent.initFakeCredentials();
                                      this.gestionHorariosService.editHorario(id_horario, '1', '20202021', '1', '1', '12345678Z', '99999', 'Pendiente', '12:30', '13:00', 'miercoles', '2022-01-13').subscribe(
                                        () => {
                                          this.tests.push({
                                            accion: "Gestion Horarios Edit",
                                            descripcion: "Edit incorrecto porque no existe la titulación..",
  ...
  private gestionTutoriasTest() {
    TestComponent.initFakeCredentials();

    this.gestionTutoriasService.deleteTutoria("-1").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Delete",
          descripcion: "Delete no válido",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678Z", "1", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Add correcto",
          flag: true
        });

        TestComponent.initFakeCredentials();
        this.gestionTutoriasService.deleteTutoria(value).subscribe(
          value => {
            this.tests.push({
              accion: "Gestion Tutorias Delete",
              descripcion: "Delete válido",
    ...
    this.gestionTutoriasService.addTutoria("20212021", "12345678Z", "1", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Año no válido",
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678", "1", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Profesor no válido",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678Z", "aa", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Espacio no válido",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678Z", "1", "No Asistido", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Asistencia no valida",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678Z", "1", "Pendiente", "2022-01-AA", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Fecha no válida",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678Z", "1", "Pendiente", "2022-01-13", "AA:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Hora de inicio no válida",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.addTutoria("20202021", "12345678Z", "1", "Pendiente", "2022-01-13", "12:00:00", "AA:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Add",
          descripcion: "Hora de fin no válida",
          flag: false
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.editTutoria("-1", "20202021", "12345678Z", "1", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "ID no válido",
          flag: false
        });
      }, error => {
    ...
    this.gestionTutoriasService.editTutoria("1", "20212021", "12345678Z", "1", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Año no válido",
    ...
    this.gestionTutoriasService.editTutoria("1", "20202021", "12345678", "1", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Profesor no válido",
    ...
    this.gestionTutoriasService.editTutoria("1", "20202021", "12345678Z", "aa", "Pendiente", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Espacio no válido",
    ...
    this.gestionTutoriasService.editTutoria("1", "20202021", "12345678Z", "1", "No Asistido", "2022-01-13", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Asistencia no valida",
    ...
    this.gestionTutoriasService.editTutoria("1", "20202021", "12345678Z", "1", "Pendiente", "2022-01-AA", "12:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Fecha no válida",
    ...
    this.gestionTutoriasService.editTutoria("1", "20202021", "12345678Z", "1", "Pendiente", "2022-01-13", "AA:00:00", "12:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Hora de inicio no válida",
    ...
    this.gestionTutoriasService.editTutoria("1", "20202021", "12345678Z", "1", "Pendiente", "2022-01-13", "12:00:00", "AA:00:00").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Edit",
          descripcion: "Hora de fin no válida",
    ...
    this.gestionTutoriasService.mostrartodas().subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Showall",
          descripcion: "Showall válido",
          flag: true
        });
      }, error => {
        this.tests.push({
    ...
    this.gestionTutoriasService.show("-1").subscribe(
      value => {
        this.tests.push({
          accion: "Gestion Tutorias Show",
          descripcion: "Show no válido",
          flag: false
        });
      }, error => {
        this.tests.push({
